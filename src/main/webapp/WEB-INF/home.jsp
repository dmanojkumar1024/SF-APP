...
<body>
    <div class="main-container">
        <div class="cloud-image">
            <img src="${pageContext.request.contextPath}/img/successCloudNew.svg" />
        </div>
        <div class="content">
            ...
            <a href="http://twitter.com/intent/tweet/?text=I%20just%20created%20a%20new%20HTML%20website%20on%20Azure%20using%20Azure%20DevOps%20Project&hashtags=AzureDevOpsProject%2CVSTS%20%40Azure%20%40VSTS">
                <img src="${pageContext.request.contextPath}/img/tweetThis.svg" />
            </a>            
        </div>
            <div class="content-body">
                ...
                <div class="next-steps-container">
                    ...
                    <div class="next-steps-body">
                        <div class="step">
                            <div class="step-icon">
                                <img src="${pageContext.request.contextPath}/img/cloneWhite.svg">
                            </div>
                        ...
                        <div class="step">
                            <div class="step-icon">
                                <img src="${pageContext.request.contextPath}/img/deployWhite.svg">
                            </div>
                        ...
                        <div class="step">
                            <div class="step-icon">
                                <img src="${pageContext.request.contextPath}/img/stackWhite.svg">
                            </div>
                            <div class="step-text"><a href="http://portal.azure.com">View your service stack in the Azure Portal</a></div>
                        </div>
                        <div class="step">
                            <div class="step-icon">
                                <img src="${pageContext.request.contextPath}/img/lightbulbWhite.svg">
                            </div>
